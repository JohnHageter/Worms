...
input_dir = Path("./Sachi/T3/week_1/")
output_h5 = Path("./Sachi/T3/output_tracks_week_1.h5")
output_video_path = Path("./Sachi/T3/annotated_week_1.mp4")
...
# ---- HDF5 setup for incremental writing ----
...
for video_path in video_paths:
    ...
    while True:
        ...
        cv2.putText(visual, f"Video #{video_count}", (10, 20), cv2.FONT_HERSHEY_SIMPLEX, 0.6, (255, 255, 255), 2)
        cv2.putText(visual, f"Frame: {global_frame_idx}", (10, 50), cv2.FONT_HERSHEY_SIMPLEX, 0.6, (255, 255, 255), 2)
        cv2.putText(visual, time_str, (10, 80), cv2.FONT_HERSHEY_SIMPLEX, 0.6, (0, 255, 0), 2)
        ...
        # ---- Store track records incrementally ----
        frame_data = np.array(
            [
                (
                    global_frame_idx,

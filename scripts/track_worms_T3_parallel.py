...
output_h5 = [
    ...
    Path("/scratch/jwhageter/Worm_Tracking/output_tracks_week_2.h5"),
]
output_video_path = [
    Path("/scratch/jwhageter/Worm_Tracking/annotated_week_1.mp4"),
    Path("/scratch/jwhageter/Worm_Tracking/annotated_week_2.mp4"),
]
...
first_video_path = sorted(input_dirs[1].glob("*.mp4"))[0]
